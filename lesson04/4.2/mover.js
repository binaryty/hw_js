let mover = {
    ...
    /**
     * Провяет столкновение с границами игрового поля, в случае столкновения игрок остается на месте.
     * @param {{x: int, y: int}} nextPosition Следующая точка пользователя.
     * @returns {boolean} true - столкновение, false - столкноение отсутствует.
     */
